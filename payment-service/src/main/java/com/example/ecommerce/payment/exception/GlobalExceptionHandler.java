...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleStripeException(StripeException exception) {
        return problemDetail(HttpStatus.BAD_GATEWAY, "Payment provider error", exception.getMessage());
    }
